...
users = [
  { username: "Mounika", email: "kitt@example.com", password: "123456", description: "A creative individual and mom of two young kids who loves giving old toys a second life. She prefers trading with others who appreciate a good deal and is always on the lookout for something fun to refresh her children's collection."},
  ...
  { username: "David", email: "david@example.com", password: "123456", description: "A practical, environmentally-conscious dad with a 7-year-old who enjoys finding new homes for gently used toys. He’s all about reducing waste and loves the idea of trading toys with other families who share the same goal." },
  ...
  { username: "Hollie", email: "hollie@example.com", password: "123456", description: "A minimalist mom with two kids who believes in the power of bartering to declutter their space. She’s always ready for a trade and loves the idea of giving away something her children have outgrown while getting something new in return." },
  { username: "Leea", email: "melany@example.com", password: "123456", description: "A non-smoker with two young kids and a playful dog. They love bartering toys to keep their children entertained while also giving their pet some new things to enjoy. They believe in reducing waste and love the thrill of a good trade." },
...
toys = [
  ...
  { name: "Stacking Blocks", user: User.all[1], category: "Educational Toys", description: "Colorful wooden blocks for stacking fun.", condition: "Used", location: "Peterbrough, United Kingdom", need_in_return: "Friends TV Series", status: "Available" },
  ...
  { name: "Clipology", user: User.all[5], category: "Educational Toys", description: "All the best clips rolled into fun.", condition: "New", location: "Newcastle, United Kingdom", need_in_return: "Stuffed Bear", status: "Available" },
  ...
  { name: "Hula Hoop", user: User.all[0], category: "Outdoor & Sports Toys", description: "Fun outdoor activity.", condition: "Excellent", location: "43 Stonegate, York, YO1 8AW, United Kingdom", need_in_return: "Painting Set", status: "Available" },
  { name: "Jump Rope", user: User.all[1], category: "Outdoor & Sports Toys", description: "Great for fitness and play.", condition: "Good", location: "11 Oakwood Drive, Bristol, BS8 4EA, United Kingdom", need_in_return: "Playdough", status: "Available" },
  { name: "Skateboard", user: User.all[2], category: "Outdoor & Sports Toys", description: "For advanced outdoor fun.", condition: "New", location: "Leeds, United Kingdom", need_in_return: "Coloring Book", status: "Available" },
  { name: "Soccer Set", user: User.all[3], category: "Outdoor & Sports Toys", description: "Includes ball and goal net.", condition: "Used", location: "71 Gloucester Road, London, SW7 4SS, United Kingdom", need_in_return: "Miniature Dollhouse", status: "Available" },
  { name: "Coloring Book", user: User.all[4], category: "Creative & Art Toys", description: "Perfect for little artists.", condition: "New", location: "47 Rosebery Avenue, London, EC1R 4SJ, United Kingdom", need_in_return: "Skateboard", status: "Available" },
  { name: "Playdough", user: User.all[5], category: "Creative & Art Toys", description: "Non-toxic and colorful.", condition: "Good", location: "15 Elmwood Crescent, Sheffield, S10 3DD, United Kingdom", need_in_return: "Jump Rope", status: "Available" },
  { name: "Craft Kit", user: User.all[6], category: "Creative & Art Toys", description: "DIY crafting fun.", condition: "Good", location: "5 Farringdon Road, London, EC1M 3JY, United Kingdom", need_in_return: "Hula Hoop", status: "Available" },
  ...
  { name: "Clay Sculpting Set", user: User.all[0], category: "Creative & Art Toys", description: "Advanced sculpting tools.", condition: "New", location: "54 High Street, Manchester, M1 1AE, United Kingdom", need_in_return: "Push Car", status: "Available" },
  { name: "Calligraphy Kit", user: User.all[1], category: "Creative & Art Toys", description: "Learn artistic writing.", condition: "New", location: "34 Park Lane, Birmingham, B1 2AW, United Kingdom", need_in_return: "Clipology", status: "Available" },
  { name: "Stuffed Bear", user: User.all[2], category: "Action Figures & Dolls", description: "Soft and cuddly bear.", condition: "New", location: "29 King Street, Liverpool, L1 8JX, United Kingdom", need_in_return: "Robotics Kit", status: "Available" },
  { name: "Baby Doll", user: User.all[3], category: "Action Figures & Dolls", description: "Cute doll for toddlers.", condition: "Used", location: "Liverpool, United Kingdom", need_in_return: "Magic Maths Game", status: "Available" },
  { name: "Superhero Action Figure", user: User.all[4], category: "Action Figures & Dolls", description: "Exciting and fun.", condition: "Good", location: "1500 St. John’s Road, Edinburgh, EH12 7SB, United Kingdom", need_in_return: "Science Kit", status: "Available" },
  { name: "Interactive Doll", user: User.all[5], category: "Action Figures & Dolls", description: "Talks and sings.", condition: "Excellent", location: "222 Church Road, Brighton, BN3 2DJ, United Kingdom", need_in_return: "Shape Sorter", status: "Available" },
  { name: "Friends TV Series", user: User.all[6], category: "Action Figures & Dolls", description: "For serious collectors.", condition: "New", location: "Norwich, United Kingdom", need_in_return: "Stacking Blocks", status: "Available" },
  { name: "Miniature Dollhouse", user: User.all[7], category: "Action Figures & Dolls", description: "Rainbow High Townhouse- 3-Story Wood Dollhouse Playset.", condition: "Good", location: "302 Green Lane, Coventry, CV3 6EF, United Kingdom", need_in_return: "Magic Maths Game", status: "Available" }
]


toy_urls = [
  "https://m.media-amazon.com/images/I/61ZnUquTtKL.__AC_SY300_SX300_QL70_ML2_.jpg",
  "https://m.media-amazon.com/images/I/815DydPAFiL.__AC_SY300_SX300_QL70_ML2_.jpg",
  ...
  "https://m.media-amazon.com/images/I/913PhZYTEAL._AC_SL1500_.jpg",
  ...
  "https://m.media-amazon.com/images/I/81akU929DTL._AC_SL1500_.jpg",
  "https://m.media-amazon.com/images/I/618WOuZ02sL.__AC_SX300_SY300_QL70_ML2_.jpg",
  "https://m.media-amazon.com/images/I/71kb8eaP81L._SL1294_.jpg",
  ...
  "https://m.media-amazon.com/images/I/61p3i2ldBDL._AC_SL1000_.jpg",
  ...
  "https://m.media-amazon.com/images/I/91a9q511W0L._AC_SL1500_.jpg",
  ...
  "https://m.media-amazon.com/images/I/81ni5F1OP1L._AC_SL1500_.jpg",
