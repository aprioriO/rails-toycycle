...
toys = [
  ...
  { name: "Stacking Blocks", user: User.all[1], category: "Educational Toys", description: "Colorful wooden blocks for stacking fun.", condition: "Used", location: "76 Rosewood Close, Milltown, MT2 5ZR, United Kingdom", need_in_return: "Friends TV Series", status: "Available" },
  ...
  { name: "Clipology", user: User.all[5], category: "Educational Toys", description: "All the best clips rolled into fun.", condition: "New", location: "154 Riverside Road, Larkhill, LH9 3UW, United Kingdom", need_in_return: "Stuffed Bear", status: "Available" },
  ...
  { name: "Skateboard", user: User.all[2], category: "Outdoor & Sports Toys", description: "For advanced outdoor fun.", condition: "New", location: "32 Beacon Hill, Westford, WF1 2HQ, United Kingdom", need_in_return: "Coloring Book", status: "Available" },
  ...
  { name: "Baby Doll", user: User.all[3], category: "Action Figures & Dolls", description: "Cute doll for toddlers.", condition: "Used", location: "28 Elmwood Drive, Harrowsfield, HF4 8JN, United Kingdom", need_in_return: "Magic Maths Game", status: "Available" },
  ...
  { name: "Friends TV Series", user: User.all[6], category: "Action Figures & Dolls", description: "For serious collectors.", condition: "New", location: "51 Pinecrest Way, Woodbridge, WB3 7EQ, United Kingdom", need_in_return: "Stacking Blocks", status: "Available" },
