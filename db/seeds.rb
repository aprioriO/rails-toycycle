...
toys = [
  ...
  { name: "Playdough", user: User.all[7], category: "Creative & Art Toys", description: "Non-toxic and colorful.", condition: "Good", location: "15 Elmwood Crescent, Sheffield, S10 3DD, United Kingdom", need_in_return: "Jump Rope", status: "Available" },
  { name: "Craft Kit", user: User.all[7], category: "Creative & Art Toys", description: "DIY crafting fun.", condition: "Good", location: "5 Farringdon Road, London, EC1M 3JY, United Kingdom", need_in_return: "Hula Hoop", status: "Available" },
  ...
  { name: "Calligraphy Kit", user: User.all[6], category: "Creative & Art Toys", description: "Learn artistic writing.", condition: "New", location: "34 Park Lane, Birmingham, B1 2AW, United Kingdom", need_in_return: "Clipology", status: "Available" },
  ...
  { name: "Interactive Doll", user: User.all[1], category: "Action Figures & Dolls", description: "Talks and sings.", condition: "Excellent", location: "222 Church Road, Brighton, BN3 2DJ, United Kingdom", need_in_return: "Shape Sorter", status: "Available" },
  { name: "Friends TV Series", user: User.all[7], category: "Action Figures & Dolls", description: "For serious collectors.", condition: "New", location: "Norwich, United Kingdom", need_in_return: "Stacking Blocks", status: "Available" },
